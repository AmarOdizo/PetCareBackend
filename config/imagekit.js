...
// Read env vars lazily via getters so Cloudflare-injected values are available
function getPublicKey() { return process.env.IMAGEKIT_PUBLIC_KEY || "public_/PfWSDFtqlaMUzirk/U1+hFG5IM="; }
function getPrivateKey() { return process.env.IMAGEKIT_PRIVATE_KEY || "private_QugDN74pUlsdvKYLK3h6aydGtTc="; }
function getUrlEndpoint() { return process.env.IMAGEKIT_URL_ENDPOINT || "https://ik.imagekit.io/dios87u67"; }
...
function uploadImage(fileData, fileName, folder = "/pets") {
  return new Promise((resolve, reject) => {
    ...
    const authHeader = "Basic " + Buffer.from(getPrivateKey() + ":").toString("base64");
...
module.exports = {
  get publicKey() { return getPublicKey(); },
  get privateKey() { return getPrivateKey(); },
  get urlEndpoint() { return getUrlEndpoint(); },
